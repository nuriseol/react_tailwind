...
import icon_contact from '../../images/icon/icon-contact.png';
...
const Sidebar = ({ sidebarOpen, setSidebarOpen }: SidebarProps) => {
  ...
  return (
    <aside
      ref={sidebar}
      className={`absolute left-0 top-0 z-9999 flex h-screen w-70 flex-col overflow-y-hidden duration-300 ease-linear bg-gradient-to-b from-[#01001F] to-[#02004A] ... dark:bg-boxdark lg:static lg:translate-x-0 ${
    ...
    >
      ...
      <div className="no-scrollbar flex flex-col overflow-y-auto duration-300 ease-linear">
        ...
        <nav className="mt-5 py-4 px-4 lg:mt-9 lg:px-6">
          ...
          <div>
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
              ...
              <SidebarLinkGroup
                activeCondition={
                  pathname === '/energy' || pathname.includes('energy')
                }
              >
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      ...
                      >
                        <p className='w-5'><img src={icon_energy} alt="" className='w-[21px]' /></p>
                        Energy
                        <svg
              ...
              <SidebarLinkGroup
                activeCondition={
                  pathname === '/facility' || pathname.includes('facility')
                }
              >
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      ...
                      >
                        <p className='w-5'><img src={icon_facility} alt="" className='w-[21px]' /></p>
                        Facility
                        <svg
                          className={`absolute right-4 top-1/2 -translate-y-1/2 fill-current ${
                            open && 'rotate-180'
                ...
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      ...
                      >
                        <p className='w-5'><img src={icon_management} alt="" className='w-[21px]' /></p>
                        Management
                        <svg
                          className={`absolute right-4 top-1/2 -translate-y-1/2 fill-current ${
                            open && 'rotate-180'
        ...
        {/* contact */}
        <div className='flex gap-4 text-white px-10 py-6 absolute left-0 bottom-0 bg-[#02004A]'>
          <img src={icon_contact} alt="logo" className='w-10' />
          <div>
            <img src={atemos_logo} alt="logo" className='w-22' />
            <p className='text-sm font-extralight'>atemos@atemos.com</p>
          </div>
        </div>
        {/* contact */}
    </aside>
